...
void wk_spi2_init(void)
{
  ...
  gpio_pin_mux_config(SPI_SCK_GPIO_PORT, GPIO_PINS_SOURCE1, GPIO_MUX_6);
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_MODERATE;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  gpio_init_struct.gpio_pins = SPI_SCK_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
  gpio_init(SPI_SCK_GPIO_PORT, &gpio_init_struct);

  /* configure the MISO pin */
  gpio_pin_mux_config(SPI_MISO_GPIO_PORT, GPIO_PINS_SOURCE14, GPIO_MUX_5);
  gpio_init_struct.gpio_drive_strength = GPIO_DRIVE_STRENGTH_MODERATE;
  gpio_init_struct.gpio_out_type = GPIO_OUTPUT_PUSH_PULL;
  gpio_init_struct.gpio_mode = GPIO_MODE_MUX;
  gpio_init_struct.gpio_pins = SPI_MISO_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
  gpio_init(SPI_MISO_GPIO_PORT, &gpio_init_struct);
